          ...
          <CarouselContent>
              {data.map((item) => {
                  ...
                  return (
                      ...
                      <Link href={`/menu/${path}`} key={id} className=" flex flex-col items-center bg-white rounded-lg p-4 transition-all ease-in-out duration-150 hover:scale-105 hover:bg-gray-300">
                               <Image
                                src={image}
                                alt={name}
                                width={200}
